...
if __name__ == "__main__":
    ...
    for key, value in funding_apr['short'].items():
        net_short_apr[key] = (value - borrow_apr['short'][key]) * 8760

    for key, value in net_short_apr.items():
        print(f'Net Short APR for {key}: {value:.4f}%')